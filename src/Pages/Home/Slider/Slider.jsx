...
const Slider = () => {
    return (
        <div className='bg-pink-100'>
         ...
         <button className="btn bg-pink-400 text-white rounded-full mt-10 ml-10 md:ml-96 text-2xl font-semibold">Shop       <span className=' ml-5 md:ml-20'>Popular  </span>       <span className=' ml-5 md:ml-20'>Toys  </span></button>
        </div>
    );
};
